...
return [
    ...
    'Create child' => 'Создать дочерний документ',
    ...
    'From' => 'Получить из',
    'From the title' => 'из заголовка',
    'From the menutitle' => 'из меню',
    ...
    'Repeat the name' => 'Из заголовка',
    'Select a value ...' => 'Выберете значение ...',
    ...
    //Техника
    'Tehnic Category' => 'Категории',
    'Tehnic' => 'Спец Техника',
    'New tehnic' => 'Недавно добавленная Спец Техника',
    'Tehnic Customer' => 'Заказы',
    'Tehnic Option' => 'Доступные опции',
    'Tehnic Option Value' => 'Опции техники',

    //Заказы
    'Customer' => 'Все заказы',
    'New customer' => 'Послдние заявки',
];
